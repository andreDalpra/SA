...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/listaTarefa.css">
</head>
<body>
    <div class="container">
        <div class="header">
            <h1>Lista de Tarefas</h1>
            <button class="btn btn-tela" onclick="openModal()">Adicionar Tarefa</button>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="editarTarefa.jsp" method="GET" style="display: inline;">
                                ...
                                <button class="btn btn-editar" onclick="openModalEdit()">Editar</button>
                            </form>
                            <button type="button" class="btn btn-danger" onclick="confirmDelete(<%=t.getId()%>)">Excluir</button>
                        </td>
                    </tr>
                    <%
                        }
        ...
        <div id="modal-container" class="modal-container">
            <div class="modal">
                ...
                <form action="${pageContext.request.contextPath}/servlet" method="post" id="task-form">
                    ...
                    <div class="form-group">
                        <label for="tipo_tarefa_id">Tipo de Tarefa ID</label>
